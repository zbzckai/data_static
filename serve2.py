# -*- coding: utf-8 -*-
"""
Created on Wed Feb 27 14:09:39 2019
...
# 创建会话，因为是从已有的Inception_v3模型中恢复，所以无需初始化
    ...
    softmax_tensor,sess = sess.graph.get_tensor_by_name('final_result:0'),sess 
    logger.debug('x1')
    return(softmax_tensor,sess)
...
if __name__ == "__main__":
  ...
  #logger.debug('开始训练进程')
  print("开始读取模型")
  softmax_tensor,sess = graph_bulid()
  print("已经读取完模型")
